      ...
      <div class="glass p-8 flex flex-col md:flex-row justify-between items-center gap-6">
        <div class="text-center md:text-left">
          ...
          <div class="flex items-center gap-4 justify-center md:justify-start">
            ...
            <button 
              @click="shareViaWA"
              class="p-4 bg-emerald-500 text-white rounded-2xl shadow-lg shadow-emerald-500/20 hover:bg-emerald-600 transition-all hover:scale-110 active:scale-95 group"
              ...
              <div class="flex items-center justify-between">
                ...
                >
                  <div class="absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform"
                    :class="gameStore.currentRoom.is_custom_words ? 'translate-x-6' : 'translate-x-0'"
                  ></div>
                </button>
              </div>
